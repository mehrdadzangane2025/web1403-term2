...
import {use, start, write} from "./07-framework-a.js";
    ...
    readFile('./users.json', 'utf8', function (error, fileData){
        if(error){
            ...
            if(foundIndex >= 0){
                ...
                write(response, 200, JSON.stringify({token: signedToken}),"token="+signedToken+"; Max-age="+LOGIN_TIME);
            }
            else{
